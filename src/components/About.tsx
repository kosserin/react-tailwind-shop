        ...
        <div className="flex flex-col xl:gap-0 gap-12">
          <div className="left-side z-10">
            ...
            <p className="text-base max-w-prose mt-14">
              ...
              najboljih modnih komada koji kombinuju klasičnu britansku
              eleganciju i sofisticiranost italijanskog dizajna.
            </p>
            ...
            <p className="text-base max-w-prose mt-14">
              ...
              vrhunskih evropskih tržišta. Sa ciljem da vam omogućimo da
              pronađete savršene komade za vaš garderober, posvećeni smo
              pružanju izuzetnog iskustva kupovine i najvišeg nivoa usluge.
            </p>
          </div>
